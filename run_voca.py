...
import glob
import argparse
from utils.run_inference import inference
...
config = read_config('training_config.cfg')



inference(config, tf_model_fname, ds_fname, audio_fname, template_fname, condition_idx, out_path)
#t.toc()
