...
def set_default_paramters(config):
    ...
    config.set('Learning Parameters', 'batch_size', '512')                     # 64
    config.set('Learning Parameters', 'learning_rate', '1e-3')                # 1e-4
    config.set('Learning Parameters', 'decay_rate', '1.0')                    # 1.0
    config.set('Learning Parameters', 'epoch_num', '150')                     # 100
